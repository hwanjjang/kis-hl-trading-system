...
with TemporaryDirectory() as tmp:
 ...
 r=reconcile(s,path,digest,apply=True);s.coverage('cash',aid,0,100,'complete',{})
 report=journal(s,[aid]);out['gross_pnl_reconciliation']={'applied':r['applied'],'statement_gross':'10','canonical_net':report['cycles'][0]['net_pnl'],'status':report['cycles'][0]['status']}
