...
TRADE_XYZ_ASSETS: tuple[TradeXyzAsset, ...] = (
    ...
    TradeXyzAsset(
        ...
        asset_class="equity_index",
        underlying_name="Nasdaq 100 Index",
        underlying_symbol="NDX",
        underlying_exchange="Nasdaq",
        listing_status="not_applicable",
        tradable=True,
        min_listing_age_weeks=0,
        notes="trade.xyz describes XYZ100 as a Nasdaq 100 style large-cap non-financial index.",
    ),
    TradeXyzAsset(
        trade_symbol="KR200",
        ...
        preferred_symbol="KORU",
        exclusion_reason="Duplicate South Korea exposure; project trades KORU instead.",
        source_url="project-rule",
        notes="Retained for historical symbol resolution; excluded from new live orders.",
    ),
    TradeXyzAsset(
        trade_symbol="JP225",
    ...
    TradeXyzAsset(
        trade_symbol="BRENTOIL",
        hyperliquid_coin="xyz:BRENTOIL",
        asset_class="commodity",
        underlying_name="Brent Crude Oil Futures",
        underlying_symbol="BZ",
        underlying_exchange="CME",
        listing_status="not_applicable",
        tradable=True,
        min_listing_age_weeks=0,
        notes="Specification Index reference uses a rolling Brent crude futures contract.",
    ),
    TradeXyzAsset(
        trade_symbol="WTIOIL",
        hyperliquid_coin="xyz:CL",
        asset_class="commodity",
        underlying_name="WTI Light Sweet Crude Oil Futures",
        ...
        min_listing_age_weeks=0,
        aliases=("CL",),
        notes="trade.xyz labels the contract WTIOIL; Hyperliquid exposes the market as xyz:CL.",
    ),
    TradeXyzAsset(
        trade_symbol="NATGAS",
        hyperliquid_coin="xyz:NATGAS",
        asset_class="commodity",
        underlying_name="Henry Hub Natural Gas Futures",
        underlying_symbol="NG",
        underlying_exchange="CME",
        listing_status="not_applicable",
        tradable=True,
        min_listing_age_weeks=0,
        notes="Specification Index reference uses a rolling Henry Hub natural gas futures contract.",
    ),
    TradeXyzAsset(
        trade_symbol="GOLD",
        hyperliquid_coin="xyz:GOLD",
        asset_class="commodity",
        underlying_name="Gold Spot",
        underlying_symbol="XAUUSD",
        underlying_exchange="Pyth",
        listing_status="not_applicable",
        tradable=True,
        min_listing_age_weeks=0,
        notes="Specification Index reference is XAU/USD spot, not a futures contract.",
    ),
    TradeXyzAsset(
        trade_symbol="SILVER",
        hyperliquid_coin="xyz:SILVER",
        asset_class="commodity",
        underlying_name="Silver Spot",
        underlying_symbol="XAGUSD",
        underlying_exchange="Pyth",
        listing_status="not_applicable",
        tradable=True,
        min_listing_age_weeks=0,
        notes="Specification Index reference is XAG/USD spot, not a futures contract.",
    ),
    TradeXyzAsset(
        trade_symbol="PLATINUM",
        hyperliquid_coin="xyz:PLATINUM",
        asset_class="commodity",
        underlying_name="Platinum Spot",
        underlying_symbol="XPTUSD",
        underlying_exchange="Pyth",
        listing_status="not_applicable",
        tradable=True,
        min_listing_age_weeks=0,
        notes="Specification Index reference is XPT/USD spot, not a futures contract.",
    ),
    TradeXyzAsset(
        trade_symbol="PALLADIUM",
        hyperliquid_coin="xyz:PALLADIUM",
        asset_class="commodity",
        underlying_name="Palladium Spot",
        underlying_symbol="XPDUSD",
        underlying_exchange="Pyth",
        listing_status="not_applicable",
        tradable=True,
        min_listing_age_weeks=0,
        notes="Specification Index reference is XPD/USD spot, not a futures contract.",
    ),
    TradeXyzAsset(
        trade_symbol="COPPER",
        hyperliquid_coin="xyz:COPPER",
        asset_class="commodity",
        underlying_name="Copper Futures",
        underlying_symbol="HG",
        underlying_exchange="CME",
        listing_status="not_applicable",
        tradable=True,
        min_listing_age_weeks=0,
        notes="Specification Index reference uses a rolling copper futures contract.",
    ),
    TradeXyzAsset(
        trade_symbol="JPY",
        hyperliquid_coin="xyz:JPY",
        asset_class="fx",
        underlying_name="USD/JPY Exchange Rate",
        underlying_symbol="USDJPY",
        underlying_exchange="Pyth",
        listing_status="not_applicable",
        tradable=True,
        min_listing_age_weeks=0,
    ...
    TradeXyzAsset(
        trade_symbol="EUR",
        hyperliquid_coin="xyz:EUR",
        asset_class="fx",
        underlying_name="EUR/USD Exchange Rate",
    ...
    TradeXyzAsset(
        ...
        asset_class="etf",
        underlying_name="Direxion Daily MSCI South Korea Bull 3X Shares",
        underlying_symbol="KORU",
        ...
        duplicate_group="south_korea_equity_beta",
        preferred_symbol="KORU",
        notes="Selected South Korea exposure instead of KR200 and EWY. References a daily 3x leveraged US-listed ETF, not the KOSPI 200 index.",
    ),
    TradeXyzAsset(
        trade_symbol="URNM",
